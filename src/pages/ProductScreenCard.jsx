            ...
            <div className="screen-row">
                ...
                <div className="screen-col">
                    ...
                    <div className="second-div div">
                        <span className="price">Prix: ${product.price}</span>
                        <div className="quantity">Quantité: 1</div>
                    </div>
                    ...
                    <div className="fourth-div div">
                        {product.countInStock === 0 ? (
                            <button className='cart cart-out' disabled >Rupture de stock</button>
                            ) : (
                            <button className='cart' onClick={addToCartHandler}>Ajouter au chariot</button>)
                        }
                        <button className='wish' onClick={addToWishHandler}>Ajouter au souhait</button>
                    </div>
                </div>
            </div>
        </div>
