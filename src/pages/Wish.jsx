    ...
    <>
        ...
        <div className="wish-container">
            <div className="wish-row">
              <h2 className="wish-title">Votre liste de souhaits</h2>
            </div>
            <div className="wish-row">
              <div className="wish-col">
                {wishItems.length === 0 ? (<h3 className='info'>Votre liste de voeux est vide.</h3>) : (
                    ...
                    {wishItems.map((item) => (
                      <div className="wish-card" key={item._id}>
                          ...
                          <div className="wish-body">
                            ...
                            <span className='wish-quantity'>Quantité: 1</span>
                          </div>
